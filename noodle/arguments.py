...
def parse_args():
    ...
    recipient.add_argument(
        "--permit", nargs="+", metavar="USER", help="give access to a user"
    )
    recipient.add_argument(
        "--revoke", nargs="+", metavar="USER", help="revoke user access"
    )
    recipient.add_argument(
        "--file", default=None, metavar="PATH", help="file to manage"
    )
